...
public class しりとり {
    ...
    private static List<String> availableWords = Arrays.asList(
            ...
            "ごはん", "まかろに", "まる", "るい", "いぬ", "ぬりえ", "えんぴつ", "つみき", "きんぎょ", "よる", "るしあ", "あらし",
            ...
            "けつ", "つみ", "みき", "きく", "くま", "まつ", "つか", "かん", "んま", "まる", "るし", "しん", "んま", "まし", 
            "しる", "るす", "すな", "なべ", "べんとう", "うた", "たまご", "ごま", "まい", "いす", "すいか", "かお", "おにぎり",
            "りょう", "よう", "うち", "ちょう", "うめ", "めん", "んこ", "こめ", "めし", "しま", "ます", "すいか", "かき", "きょう",
            "うら", "らい", "いえ", "えんぴつ", "つば", "ばなな", "なす", "すし", "しん", "んま", "まな", "なみ", "みかん", "んご",
            "ごろ", "ろう", "うま", "まし", "しろ", "ろうか", "かき", "きむ", "むし", "しん", "んえ", "えんぴつ", "つく", "くま",
            "まる", "るい", "いぬ", "ぬか", "かみ", "みかん", "んま", "まくら", "らく", "くし", "しん", "んま", "まく", "くみ",
            "みそ", "そば", "ばなな", "なべ", "べんとう", "うす", "すいか", "かみ", "みん", "んま", "まま", "ます", "すけ", "けい",
            "いん", "んま", "まる", "るい", "いぬ", "ぬいぐるみ", "みず", "ずきん", "んま", "まつ", "つけ", "けん", "んま", "まい",
            "いし", "しん", "んま", "まさ", "さくら", "らい", "いと", "とけ", "けん", "んま", "まな", "なむ", "むし", "しん",
            "んま", "まつ", "つく", "くろ", "ろう", "うま", "まく", "くち", "ちく", "くじ", "じけ", "けし", "しん", "んま", "まむ",
            "むぎ", "ぎょう", "うら", "らく", "くろ", "ろう", "うし", "しん", "んま", "まん", "んま", "まめ"
    );
